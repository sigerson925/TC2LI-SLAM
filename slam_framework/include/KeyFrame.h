...
public:
    ...
    // PointCloud
    PointCloudXYZIN::Ptr mKeyFramePcl;
    PointCloudXYZIN::Ptr mKeyFrameCornerPcl;
    PointCloudXYZIN::Ptr mKeyFrameSurfacePcl;
    double mCloudTime;
    bool mHasPointCloud = 0;
    LIDAR::LidarProperties* mLidarProps;
