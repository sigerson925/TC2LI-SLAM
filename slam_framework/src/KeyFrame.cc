...
KeyFrame::KeyFrame():
        ...
        NLeft(0), NRight(0), mnNumberOfOpt(0), mbHasVelocity(false), mKeyFramePcl(pcl::PointCloud<PointXYZINormal>::Ptr()), mCloudTime(0)
{
    mKeyFrameCornerPcl.reset(new pcl::PointCloud<PointXYZINormal>());
    mKeyFrameSurfacePcl.reset(new pcl::PointCloud<PointXYZINormal>());
