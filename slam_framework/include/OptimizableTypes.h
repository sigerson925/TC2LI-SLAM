...
#ifndef OPTIMIZABLETYPES_H
#define OPTIMIZABLETYPES_H
...
class EdgeSim3ProjectXYZ : public  g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, TC2LI_SLAM::VertexSim3Expmap>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeSim3ProjectXYZ();
    ...
    void computeError()
    {
        const TC2LI_SLAM::VertexSim3Expmap* v1 = static_cast<const TC2LI_SLAM::VertexSim3Expmap*>(_vertices[1]);
        const g2o::VertexSBAPointXYZ* v2 = static_cast<const g2o::VertexSBAPointXYZ*>(_vertices[0]);
