...
#ifndef OPTIMIZER_LIDAR_H
#define OPTIMIZER_LIDAR_H
...
class OptimizerWithLidar
{
    static LIDAR::LidarParam* mLidarParam; 
public:
    void static SetLidarParam(LIDAR::LidarParam * pLidarParam)
    {
        mLidarParam = new LIDAR::LidarParam( *pLidarParam );
    }
    void static LocalLVBundleAdjustment(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges);
    // For inertial systems
    void static LocalLVIBA(KeyFrame *pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool bLarge = false, bool bRecInit = false);
